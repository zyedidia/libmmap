...
uint64_t
mm_mapany(MMAddrSpace *mm, size_t len, int prot, int flags, int fd,
    off_t offset);
...
uint64_t
mm_mapat(MMAddrSpace *mm, uint64_t addr, size_t len, int prot, int flags,
    int fd, off_t offset);
...
uint64_t
mm_mapat_cb(MMAddrSpace *mm, uint64_t addr, size_t len, int prot, int flags,
...
int
mm_unmap(MMAddrSpace *mm, uint64_t addr, size_t len);
...
int
mm_unmap_cb(MMAddrSpace *mm, uint64_t addr, size_t len, UpdateFn ufn,
    void *udata);
...
int
mm_protect(MMAddrSpace *mm, uint64_t addr, size_t len, int prot);
...
int
mm_protect_cb(MMAddrSpace *mm, uint64_t addr, size_t len, int prot,
